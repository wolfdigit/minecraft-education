...
execute @s[scores={f6-rocket-comp=1}] ~ ~ ~ codebuilder navigate @p true https://meecode.blob.core.windows.net/everglade/ci/index.html?lesson=https://page.wolfdigit.csie.org/minecraft-education/islands/island_6/Misc/From_Rocket_To_Airport.json
...
execute @s[scores={f6-rocket-comp=0}] ~ ~ ~ title @s subtitle 看來應該有什麼地方搞砸了...
execute @s[scores={f6-rocket-comp=0}] ~ ~ ~ title @s title 噢不...
