...
execute @p[x=1019, y=159, z=68, r=30] ~ ~ ~ title @p title 走到彈跳墊(Bounce Pad)上開始

#Disable Whstle
scoreboard players set @a whistle-enabled 0

# Open the Notebook URL (using false always)
codebuilder navigate @p false https://notebooks.minecrafteduservices.com/everglade/ci/index.html?lesson=https://page.wolfdigit.csie.org/minecraft-education/islands/island_5/Bounce/Bounce.json
