...
execute @p[x=1019, y=159, z=68, r=30, scores={f5-tower-comp=0}] ~ ~ ~ title @p title 噢不...
execute @p[x=1019, y=159, z=68, r=30, scores={f5-tower-comp=0}] ~ ~ ~ title @p subtitle 離開任務。 你隨時可以再次開始。 
