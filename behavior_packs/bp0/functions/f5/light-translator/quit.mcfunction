...
execute @p[x=1010, y=154, z=137, r=30, scores={f5-light-comp=0}] ~ ~ ~ title @p title 噢不...
execute @p[x=1010, y=154, z=137, r=30, scores={f5-light-comp=0}] ~ ~ ~ title @p subtitle 離開任務。 你隨時可以再次開始。 
