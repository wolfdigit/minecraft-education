...
execute @p[x=1010, y=154, z=137, r=30] ~ ~ ~ title @p title 走到你的agent那邊開始

#Disable Whstle
scoreboard players set @a whistle-enabled 0

# Open the Notebook URL (using false always)
codebuilder navigate @p false https://notebooks.minecrafteduservices.com/everglade/ci/index.html?lesson=https://page.wolfdigit.csie.org/minecraft-education/islands/island_5/Translator/Translator.json
