...
execute @p[scores={f5-status=500070}] ~ ~ ~ title @p title 世界完成！
execute @p[scores={f5-status=500070}] ~ ~ ~ title @p subtitle 你完成了島嶼5

execute @p[scores={f5-status=500070}] ~ ~ ~ function f5/npcs/particles

# If the world has not been completed
execute @p[scores={f5-status=500000..500059}] ~ ~ ~ title @p subtitle 你必須完成所有的任務才能完成這個世界！
