...
#Run story notebook
codebuilder navigate @p true https://meecode.blob.core.windows.net/everglade/ci/index.html?lesson=https://page.wolfdigit.csie.org/islands/island_5/Telescope_Op/To_PM.json
