...
#Detect redstone
execute @p[scores={f5-wire-prog=1, f5-wire-title=0}] ~ ~ ~ detect 1021 156 91 redstone_wire -1 title @p title 剩一半了！
...
execute @p[x=1021, y=153, z=103, r=30, scores={f5-wire-prog=1..20}] ~ ~ ~ title @p actionbar 按下"C"或觸控Agent圖示開始寫程式
