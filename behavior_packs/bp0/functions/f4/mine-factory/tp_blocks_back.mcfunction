...
execute @p[scores={f4-mine-f-prog=1, f4-mine-f-title=0}] ~ ~ ~ detect 951 144 611 wool 3 title @p title 找到鑽石！
execute @p[scores={f4-mine-f-prog=1, f4-mine-f-title=0}] ~ ~ ~ detect 951 144 611 wool 3 title @p subtitle 還需要2個
...
execute @p[scores={f4-mine-f-prog=13, f4-mine-f-title=1}] ~ ~ ~ detect 951 144 611 wool 3 title @p title 找到鑽石！
execute @p[scores={f4-mine-f-prog=13, f4-mine-f-title=1}] ~ ~ ~ detect 951 144 611 wool 3 title @p subtitle 還需要1個
...
execute @p[scores={f4-mine-f-prog=19, f4-mine-f-title=2}] ~ ~ ~ detect 951 144 611 wool 3 title @p title 找到所有鑽石了！
