...
execute @p[scores={f4-forest-title=6}] ~ ~ ~ title @p title 全都補好了！
execute @p[scores={f4-forest-title=6}] ~ ~ ~ title @p subtitle 這艘飛船準備好再次翱翔天際了
...
#Run story notebook
codebuilder navigate @p true https://notebooks.minecrafteduservices.com/everglade/ci/index.html?lesson=https://page.wolfdigit.csie.org/minecraft-education/islands/island_4/Prime_Minster/Cert_To_PM_1.json
