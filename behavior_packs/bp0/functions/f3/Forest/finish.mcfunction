...
execute @p[scores={f3-forest-comp=1}] ~ ~ ~ title @s subtitle 這些小禮物感謝你的幫忙...
execute @p[scores={f3-forest-comp=1}] ~ ~ ~ title @s title 做得好！
...
execute @p[scores={f3-forest-comp=1}] ~ ~ ~  codebuilder navigate @p true https://notebooks.minecrafteduservices.com/everglade/ci/index.html?lesson=https://page.wolfdigit.csie.org/minecraft-education/islands/island_3/Wizard/wizard_to_mine_1.json
